...
VALUES
('H001', 1, 1, 'LU', '08:00', 'T', 40, true, NOW(), NOW()),
('H002', 2, 1, 'MA', '10:00', 'L', 40, true, NOW(), NOW()),
('H003', 3, 2, 'MI', '14:00', 'P', 35, true, NOW(), NOW()),
('H004', 4, 2, 'JU', '16:00', 'T', 35, true, NOW(), NOW()),
('H005', 5, 1, 'VI', '09:00', 'L', 40, true, NOW(), NOW());
...
INSERT INTO direcciones (usuario_id, direccion, referencia, distrito, provincia, departamento, created_at, updated_at)
VALUES
...
(14, 'Pasaje Los Pinos 654', 'A espaldas del mercado', 'San Juan de Lurigancho', 'Lima', 'Lima', NOW(), NOW());

-- Insertar info familiar
INSERT INTO info_familiars (usuario_id, nomPadre, ocuPadre, gradoPadre, telPadre, nomMadre, ocuMadre, gradoMadre, telMadre, created_at, updated_at)
VALUES
...
(14, 'José García', 'Contador', 'Universitaria completa', '987654329', 'Elena Chávez', 'Secretaria', 'Tecnico', '987654330', NOW(), NOW());

-- Insertar info profesional
INSERT INTO info_profesionals (usuario_id, centroTrabajo, direccionCentroTrabajo, telCentroTrabajo, cargo, created_at, updated_at)
VALUES
